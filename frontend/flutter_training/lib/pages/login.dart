...
class _LoginPage extends State<LoginPage> {
  ...
  FormGroup buildEmployeeForm() => fb.group(<String, Object>{
        userNameKey: FormControl<String>(value: 'ramky', validators: [
          Validators.required,
        ]),
        passwordKey: FormControl<String>(value: 'eGov@123', validators: [
          Validators.required,
        ]),
        tenantIdKey: FormControl<String>(value: 'pg.citya', validators: [
          Validators.required,
        ]),
      });
