...
class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    CreateWageSeekerRoute.name: (routeData) {
      return MaterialPageX<dynamic>(
        routeData: routeData,
        child: const CreateWageSeekerPage(),
      );
    },
  };
  ...
  List<RouteConfig> get routes => [
        ...
        RouteConfig(
          ...
          children: [
            ...
            RouteConfig(
              CreateWageSeekerRoute.name,
              path: 'create-wage-seeker',
              parent: AuthenticatedRouteWrapper.name,
            ),
          ],
        ),
...
/// generated route for
/// [CreateWageSeekerPage]
class CreateWageSeekerRoute extends PageRouteInfo<void> {
  ...
  static const String name = 'CreateWageSeekerRoute';
}
